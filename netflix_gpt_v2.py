...
system_text="""
Based on the movie viewing history that the user enters and the ratings for each movie, 
select the next movie and rating that the user will choose from among the options.
Think you're a real user and choose the next movie considering the genre, plot, cast and crew, and release year
"""


with open("data/netflix_argument_v2.jsonl", "a") as file:
    pt=0
    ct=0
